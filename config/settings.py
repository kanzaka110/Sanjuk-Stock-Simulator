...
HOLDINGS_RIA: dict[str, dict] = {
    ...
    "082740.KS": {"shares": 8, "avg_cost_krw": 61_000},    # 한화엔진 (6/18 매수)
}
...
#   합계 ≈ ₩20,485,776
# RIA_CASH: 20,480,776 - 1,656,000(6/17 KODEX 200 12주 @138,000) - 488,000(6/18 한화엔진 8주 @61,000) = 18,336,776
RIA_CASH: float = 18_336_776.0
