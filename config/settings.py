...
HOLDINGS_GENERAL: dict[str, dict] = {
    ...
    # LMT: 1주 → 2026-06-22 전량 매도 @ $510.19 (손절, -$128.81 / -20.2%)
    #   - 2026-06-29: LMT 5주 @ $505.00 매수 (재진입)
    "LMT": {"shares": 5, "avg_cost_usd": 505.00, "ria_eligible": 0},
    #   - 2026-06-29: NVDA 10주 @ $190.00 매수
    "NVDA": {"shares": 10, "avg_cost_usd": 190.00, "ria_eligible": 0},
}
...
HOLDINGS_RIA: dict[str, dict] = {
    "069500.KS": {"shares": 16, "avg_cost_krw": 140_825},  # KODEX 200 (6/26 4주 @ ₩137,300 추가, 평단 140,825)
    "091160.KS": {"shares": 9, "avg_cost_krw": 178_000},   # KODEX 반도체 (6/19 매수)
    "229200.KS": {"shares": 30, "avg_cost_krw": 15_500},   # KODEX 코스닥150 (6/26 매수)
    "352820.KS": {"shares": 5, "avg_cost_krw": 189_700},   # 하이브 (6/30 매수)
}
...
IRP_CASH: float = 292_318.0
# IRP_DEFAULT_OPTION: 삼성증권 스샷 기준 2026-06-24 디폴트옵션 ₩5,215,038
IRP_DEFAULT_OPTION: float = 5_215_038.0
...
HOLDINGS_ISA: dict[str, dict] = {
    ...
    # 161510.KS: PLUS 고배당주 13주 → 2026-06-23 전량 매도 @ ₩24,875 (-11.48%)
...
DEFAULT_CASH: float = 18_665_918.0
